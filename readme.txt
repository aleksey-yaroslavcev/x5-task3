...
4. Создать интерфейс Worker
        void work();

    Создать класс Employee, который наследуется от Human и реализует интерфейсы Worker
...
12. Создать класс Intern, который наследуется от класса Student и реализует интерфейс Worker
